  ...
  _createClass(Hook, [{
    ...
    value: function process(thing) {
      ...
      return new Promise(function (resolve, reject) {
        return resolve(_this.preProcess(thing)).catch(reject);
      }).then(function (preProcessResult) {
        if (preProcessResult) {
          if (_this.flags.execute) {
            return new Promise(function (resolve, reject) {
              return resolve(_this.execute(thing)).catch(reject);
            });
          }
        }
        return new Promise(function (resolve, reject) {
        ...
        if (_this.flags.hook && _this.isHook(_this.hook)) {
          return new Promise(function (resolve, reject) {
            return _this.hook.process(thing).then(resolve).catch(reject);
          });
        } else {
          return new Promise(function (resolve, reject) {
            return resolve();
...
var Anchor = function (_Hook) {
  ...
  _createClass(Anchor, [{
    ...
    value: function process(thing) {
      ...
      // preProcess() controls whether this hook executes
      return new Promise(function (resolve, reject) {
        return resolve(_this3.preProcess(thing)).catch(reject);
      }).then(function (preProcessResult) {
        if (preProcessResult) {
          if (_this3.flags.execute) {
            return new Promise(function (resolve, reject) {
              return resolve(_this3.execute(thing)).catch(reject);
            });
          }
        }
        return new Promise(function (resolve, reject) {
        ...
        if (_this3.flags.hook && _this3.isHook(_this3.hook)) {
          return new Promise(function (resolve, reject) {
            return _this3.hook.process(thing).then(resolve).catch(reject);
          });
        } else {
          return new Promise(function (resolve, reject) {
            return resolve();
